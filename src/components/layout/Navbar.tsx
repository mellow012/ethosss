        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <button
                ...
                className={`relative px-4 py-2 text-sm font-medium rounded-md transition-colors ${pathname === link.href || (link.href !== '/' && pathname.startsWith(link.href))
                    ? 'text-forest'
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="hidden lg:flex bg-gold hover:bg-gold-dark text-bark font-bold rounded-xl h-10 px-6 text-xs uppercase tracking-wider shadow-sm"
            >
              Get Involved
            </Button>
                  ...
                  <nav className="flex flex-col gap-1">
                    {navLinks.map((link) => (
                      <SheetClose asChild key={link.href}>
                        <button
                          onClick={() => handleNav(link.href)}
                          className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${pathname === link.href || (link.href !== '/' && pathname.startsWith(link.href))
